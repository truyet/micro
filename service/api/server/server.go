...
import (
	...
	ahandler "github.com/micro/micro/v3/platform/api/handler"
	aapi "github.com/micro/micro/v3/platform/api/handler/api"
	"github.com/micro/micro/v3/platform/api/handler/event"
	ahttp "github.com/micro/micro/v3/platform/api/handler/http"
	arpc "github.com/micro/micro/v3/platform/api/handler/rpc"
	"github.com/micro/micro/v3/platform/api/handler/web"
	"github.com/micro/micro/v3/platform/api/resolver"
	"github.com/micro/micro/v3/platform/api/resolver/grpc"
	"github.com/micro/micro/v3/platform/api/resolver/host"
	"github.com/micro/micro/v3/platform/api/resolver/path"
	"github.com/micro/micro/v3/platform/api/resolver/subdomain"
	"github.com/micro/micro/v3/platform/api/router"
	regRouter "github.com/micro/micro/v3/platform/api/router/registry"
	"github.com/micro/micro/v3/platform/api/server"
	"github.com/micro/micro/v3/platform/api/server/acme"
	"github.com/micro/micro/v3/platform/api/server/acme/autocert"
	"github.com/micro/micro/v3/platform/api/server/acme/certmagic"
	httpapi "github.com/micro/micro/v3/platform/api/server/http"
	"github.com/micro/micro/v3/platform/handler"
	"github.com/micro/micro/v3/platform/helper"
	rrmicro "github.com/micro/micro/v3/platform/resolver/api"
	"github.com/micro/micro/v3/platform/sync/memory"
