...
import (
	...
	"github.com/micro/micro/v3/platform/api/handler/rpc"
	"github.com/micro/micro/v3/platform/api/router"
	rregistry "github.com/micro/micro/v3/platform/api/router/registry"
	rstatic "github.com/micro/micro/v3/platform/api/router/static"
